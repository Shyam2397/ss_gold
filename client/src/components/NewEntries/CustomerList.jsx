      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 sm:mb-8">
        ...
        <div className="relative w-full sm:w-80">
          <input
            ...
            className="w-full pl-10 sm:pl-12 pr-4 py-2.5 sm:py-3 text-base sm:text-lg rounded-xl border-2 border-amber-200 focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200"
          />
          <FiSearch className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 text-gray-400 h-5 w-5 sm:h-6 sm:w-6" />
        </div>
      </div>
              ...
              <table className="min-w-full divide-y divide-amber-200">
                ...
                <tbody className="bg-white divide-y divide-amber-100">
                  {customers.map((customer, index) => (
                    ...
                    >
                      <td className="px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-5 whitespace-nowrap text-base sm:text-lg font-medium text-amber-900">{customer.code}</td>
                      <td className="px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-5 whitespace-nowrap text-base sm:text-lg text-gray-900">{customer.name}</td>
                      <td className="hidden sm:table-cell px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-5 whitespace-nowrap text-base sm:text-lg text-gray-500">{customer.phoneNumber}</td>
                      <td className="hidden md:table-cell px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-5 whitespace-nowrap text-base sm:text-lg text-gray-500">{customer.place}</td>
