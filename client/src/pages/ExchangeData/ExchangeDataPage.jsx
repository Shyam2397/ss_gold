...
const ExchangeDataPage = () => {
  ...
  return (
    <div className="p-6 sm:p-8 bg-gradient-to-br from-[#F9F3F1] to-[#FFF8F0] shadow-lg rounded-xl max-w-full h-full text-[#391145]">
      ...
      {error && (
        <div className="mb-4 p-3 bg-red-50 border-l-4 border-red-500 text-red-700 rounded-r flex items-center space-x-2 text-sm">
      ...
      {successMessage && (
        <div className="mb-4 p-3 bg-green-50 border-l-4 border-green-500 text-green-700 rounded-r flex items-center space-x-2 text-sm">
          <FiAlertCircle className="h-4.5 w-4.5" />
